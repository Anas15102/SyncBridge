...
final class XPCHelperClient: NSObject {
    ...
    private let serviceName = "theboringteam.boringnotch.SyncBridgeXPCHelper"
    
    private var remoteService: RemoteXPCService<SyncBridgeXPCHelperProtocol>?
    ...
    @MainActor
    private func ensureRemoteService() -> RemoteXPCService<SyncBridgeXPCHelperProtocol> {
        ...
        let service = RemoteXPCService<SyncBridgeXPCHelperProtocol>(
            connection: conn,
            remoteInterface: SyncBridgeXPCHelperProtocol.self
        )
    ...
    @MainActor
    private func getRemoteService() -> RemoteXPCService<SyncBridgeXPCHelperProtocol>? {
        remoteService
    }
