//
//  SyncBridgeXPCHelperProtocol.swift
//  SyncBridgeXPCHelper
//
...
@objc protocol SyncBridgeXPCHelperProtocol {
...
/*
 To use the service from an application or other process, use NSXPCConnection to establish a connection to the service by doing something like this:
     ...
     connectionToService = NSXPCConnection(serviceName: "theboringteam.boringnotch.SyncBridgeXPCHelper")
     connectionToService.remoteObjectInterface = NSXPCInterface(with: (any SyncBridgeXPCHelperProtocol).self)
     connectionToService.resume()

 Once you have a connection to the service, you can use it like this:

     if let proxy = connectionToService.remoteObjectProxy as? SyncBridgeXPCHelperProtocol {
